            ...
            <h1 className="text-center text-xl my-5">Visit us on social media</h1>
                <ul className="flex mt-2 gap-5">
                  <li className=" flex flex-col items-center space-x-2 gap-2">
                                        <a href="https://www.linkedin.com/company/ecfatum/" target="_blank" rel="noopener noreferrer"><FaLinkedin className="text-3xl text-amber-500 transition-all duration-100 hover:text-4xl" /></a>
                                      </li>
                                      <li className=" flex flex-col items-center space-x-2 gap-2">
                                        <a href="https://www.facebook.com/share/1KWRft5gUG/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer"><FaFacebook className="text-3xl text-amber-500 transition-all duration-100 hover:text-4xl"/></a>
                                      </li>
                                      <li className=" flex flex-col items-center space-x-2 gap-2">
                                        <a href="" target="_blank" rel="noopener noreferrer"><FaYoutube className="text-3xl text-amber-500 transition-all duration-100 hover:text-4xl"/></a>
                                      </li>
                                      <li className=" flex flex-col items-center space-x-2 gap-2">
                                        <a href="" target="_blank" rel="noopener noreferrer"><FaXTwitter className="text-3xl text-amber-500 transition-all duration-100 hover:text-4xl"/></a>
                                      </li>
                                      <li className="flex flex-col items-center space-x-2 gap-2">
                                        <a href="https://www.instagram.com/ecfatum_ltd?igsh=YzFnN3FoNncxZTl2&utm_source=qr" target="_blank" rel="noopener noreferrer"><FaInstagram className="text-3xl text-amber-500 transition-all duration-100 hover:text-4xl"/></a>
                                      </li>
                                      <li className="flex flex-col items-center space-x-2 gap-2">
                                        <a href="" target="_blank" rel="noopener noreferrer"><FaWhatsapp className="text-3xl text-amber-500 transition-all duration-100 hover:text-4xl"/></a>
                                      </li>
                                      <li className="flex flex-col items-center space-x-2 gap-2">
                                      <a href="https://www.tiktok.com/@ecfatumlimited?_t=8otbT2grLLZ&_r=1"  target="_blank" rel="noopener noreferrer"><FaTiktok className="text-3xl text-amber-500 transition-all duration-100 hover:text-4xl"/></a>
                                      </li>
                          </ul>
          </motion.div>
        </div>

...
//                         <img className="h-6 w-22 5 md:h-12 md:w-45" src={logo} alt="ecfatum-logo" />
//                     </Link>
...
//                                     <ScrollLink to={item.href} smooth={true} duration={800} offset={-70} className="cursor-pointer">
//                                         {item.label}
//                                     </ScrollLink>
//                                 </li>
//                             ))}
                ...
                <AnimatePresence>
                    {mobileDrawerOpen && (
                        <motion.div
                            ...
                            className="fixed right-0 z-50 bg-neutral-900 w-full p-12 flex flex-col justify-center items-center lg:hidden"
                        >
                            <ul className='flex flex-col items-center'>
                                {navItems.map((item, index) => (
                                    <li key={index} className="py-4">
                                        <ScrollLink 
                                            ...
                                            onClick={() => setMobileDrawerOpen(false)} // Close menu when clicked
                                        >
                                            {item.label}
                                        </ScrollLink>
                                    </li>
